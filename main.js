...
document.getElementById("newRoundBtn").onclick = () => {
    ...
    // очистка всех шагов
    document.querySelector("#step-parse .tdc-output").innerHTML = "";
    document.querySelector("#step-modeselect .tdc-output").innerHTML = "";
    document.querySelector("#step-process .tdc-output").innerHTML = "";
    document.querySelector("#step-balance .tdc-output").innerHTML = "";
    document.querySelector("#step-output .tdc-output").innerHTML = "";
    document.querySelector("#step-density .tdc-output").innerHTML = "1.00";

    // визуальный эффект
    document.getElementById("newRoundBtn").textContent = "Раунд обновлён";
    setTimeout(() => {
        document.getElementById("newRoundBtn").textContent = "Новый раунд";
    }, 800);
};
